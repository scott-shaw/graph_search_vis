...
sf::RoundedRectangleShape::RoundedRectangleShape(const Vector2f& size, float radius, unsigned int cornerPointCount) {
    mySize = size;
    myRadius = radius;
...
void sf::RoundedRectangleShape::setSize(const Vector2f& size) {
    mySize = size;
    update();
}
